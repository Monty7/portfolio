...
const articlesText = [
    ...
    },
    {
        ...
        image: "./src/img/CK-wireframe.jpg",
...
const renderAllRowArticles = articlesText.map((article, index) => ( <ArticleProject key={index} image={article.image} gitLink={article.gitLink} liveLink={article.liveLink} name={article.name} description={article.description} technologies={article.technologies}/> )
    )
